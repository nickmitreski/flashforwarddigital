  ...
  'C:': {
    ...
    children: {
      'Desktop': {
        type: "folder",
        children: {
          'My Computer': { type: "shortcut", target: "C:/My Computer" },
          'Recycle Bin': { type: "shortcut", target: "C:/Recycle Bin" },
          ...
          'Modern Site': { type: "shortcut", target: "/modern", isExternalLink: true, icon: "/lovable-uploads/error.png" },
          'README.txt': { type: "file", content: "Welcome to Flash Forward Digital!" },
          'DANGER!!!': {
            type: "folder",
            children: {
