...
export function createWindow(title, customCode) {
  ...
  switch (title) {
    ...
    case 'File Explorer':
      ...
      break;
    case 'Snake':
      win.classList.add('threeD-window');
      bodyHTML = `<div class="window-content">`;
    ...
    case 'Speak Bonzi, Speak!':
      ...
      break;
    case 'Mario':
      win.classList.add('mario-window');
      ...
      break;
    case 'VirtualBox':
      win.classList.add('vm-window');
      bodyHTML = `<div class="window-body vm-window">`;
      content = customCode ? customCode : `
        <div style="width: calc(100%-20px); height: 100%;">
          <iframe src="https://flashforwarddigital.com/windows-xp/" style="width: 100%; height: 100%; border: none; display: block;"></iframe>
        </div>
      `;
